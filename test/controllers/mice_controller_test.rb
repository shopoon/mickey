...
class MiceControllerTest < ActionController::TestCase
  ...
  test "should create mouse" do
    assert_difference('Mouse.count') do
      post :create, mouse: { family_id: @mouse.family_id, sequence_id: @mouse.sequence_id, sex_id: @mouse.sex_id, status: @mouse.status }
    end
  ...
  test "should update mouse" do
    patch :update, id: @mouse, mouse: { family_id: @mouse.family_id, sequence_id: @mouse.sequence_id, sex_id: @mouse.sex_id, status: @mouse.status }
    assert_redirected_to mouse_path(assigns(:mouse))
  end
